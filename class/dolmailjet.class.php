...
require_once(DOL_DOCUMENT_ROOT_ALT."/mailjet/class/php-mailjet.class-mailjet-0.1.php");
...
class DolMailjet extends CommonObject
{
	...
	function listCampaignConcatsList($typeresult='array'){
		...
		dol_syslog(get_class($this)."::listCampaignConcatsList apriori jai une instance:".$this->mailjet_contact_list_id, LOG_ERR);
		$params = array(
			'id' => $this->mailjet_contact_list_id
		);
